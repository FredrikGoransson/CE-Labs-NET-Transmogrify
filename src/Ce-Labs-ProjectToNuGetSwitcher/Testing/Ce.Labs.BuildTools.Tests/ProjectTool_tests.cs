...
namespace Ce.Labs.BuildTools.Tests
{
    public class ProjectTool_tests
    {
        ...
        {
            var csProjRelativePath =
                "../../../../../Ce.Labs.Samples.ClassicProject/Ce.Labs.Samples.ClassicProject.csproj";
            Should_be_able_to_load_files(csProjRelativePath);
        }

        [Test]
        public void Should_be_able_to_load_files_in_cps_project()
        {
            var csProjRelativePath = "../../../../../Ce.Labs.Samples.CPSProject/Ce.Labs.Samples.CPSProject.csproj";
            Should_be_able_to_load_files(csProjRelativePath);
        }
        ...
        public void Should_be_able_to_load_file_properties_in_classic_project()
        {
            var csProjRelativePath =
                "../../../../../Ce.Labs.Samples.ClassicProject/Ce.Labs.Samples.ClassicProject.csproj";
            Should_be_able_to_load_file_properties(csProjRelativePath);
        }
        ...
        public void Should_be_able_to_load_project_properties_in_classic_project()
        {
            var csProjRelativePath =
                "../../../../../Ce.Labs.Samples.ClassicProject/Ce.Labs.Samples.ClassicProject.csproj";
            Should_be_able_to_load_project_properties(csProjRelativePath,
